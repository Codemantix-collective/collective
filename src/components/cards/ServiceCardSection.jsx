    ...
    <section className={`relative w-full overflow-hidden py-24 ${getBackgroundClasses()}`}>
      ...
      <div className="container relative mx-auto px-6">
        ...
        >
          ...
          <h2
            className={`mb-6 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl ${getTextClasses()}`}
          >
            {title}
          </h2>
          ...
          <p className={`mx-auto max-w-3xl text-xl leading-relaxed ${getDescriptionClasses()}`}>
            {description}
          </p>
        </motion.div>
