    ...
    <section className="bg-gray-50 px-4 py-20 dark:bg-gray-900 md:px-8 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-8 rounded-3xl border border-gray-100 bg-white p-4 shadow-2xl dark:border-gray-700 dark:bg-gray-800 sm:p-6 md:gap-12 md:p-8 lg:grid-cols-2 lg:p-10">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <h2 className="mb-6 text-center text-3xl font-bold leading-tight text-primary-900 dark:text-white sm:text-4xl md:text-5xl lg:text-left">
            Send Us a{" "}
          ...
          <div className="mt-8 space-y-4">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="text-sm sm:text-base">Enugu, Nigeria</span>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className={`w-full transform rounded-xl py-4 font-semibold text-white transition-all duration-300 hover:scale-[1.02] ${
                status === "sending"
