        ...
        >
          <div className="mb-16 text-center">
            ...
            >
              <Link
                href="/projects"
                className="group relative inline-flex transform items-center gap-2 rounded-2xl bg-gradient-to-r from-secondary-500 to-secondary-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-secondary-600 hover:to-secondary-700 hover:shadow-xl"
              >
              ...
              <Link
                href="/services"
                className="group inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-8 py-4 text-lg font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/30 hover:bg-white/20"
              >
