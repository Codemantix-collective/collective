    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute -right-32 top-20 h-64 w-64 rounded-full bg-gradient-to-br from-primary-200/30 to-accent-200/30 blur-3xl"
        />
        <motion.div
          animate={{
            x: [0, -80, 60, 0],
          ...
          className="absolute -left-32 bottom-20 h-80 w-80 rounded-full bg-gradient-to-br from-secondary-200/30 to-primary-200/30 blur-3xl"
        />
      ...
      <div className="container relative mx-auto px-6">
        ...
        >
          ...
          <h2 className="mb-6 text-4xl font-bold text-slate-900 dark:text-white md:text-5xl lg:text-6xl">
            Your Trusted
