  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Optimized Floating Elements - Only animate when visible */}
        <motion.div
          animate={
            isVisible
              ? {
          ...
          className="absolute -right-40 -top-40 h-80 w-80 rounded-full bg-gradient-to-br from-primary-400/20 to-accent-400/30 blur-3xl"
        />
        <motion.div
          animate={{
            x: [0, -100, 70, 0],
          ...
          className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-gradient-to-br from-secondary-400/15 to-accent-400/25 blur-3xl"
        />

        {/* Floating service-themed particles */}
        {[...Array(30)].map((_, i) => (
          <motion.div
            key={i}
            animate={{
