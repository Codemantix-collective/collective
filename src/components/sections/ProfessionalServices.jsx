  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="container relative mx-auto px-6 py-24">
        ...
        >
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-accent-600 to-secondary-600 p-12 shadow-2xl">
            ...
            <div className="relative">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 font-semibold text-primary-700 shadow-xl transition-all duration-300 hover:shadow-2xl"
              >
                Start Your Project
            ...
            <div className="absolute -bottom-20 -left-20 h-32 w-32 rounded-full bg-white/5 blur-2xl" />
          </div>
        </motion.div>
      </div>
    </section>
