    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute right-20 top-20 h-64 w-64 rounded-full bg-gradient-to-br from-accent-400/20 to-secondary-400/30 blur-3xl"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-20 left-20 h-80 w-80 rounded-full bg-gradient-to-tr from-primary-400/20 to-accent-400/20 blur-3xl"
        />
      </div>
              ...
              return (
                ...
                >
                  <div className="relative h-full rounded-2xl border border-primary-200 bg-white/80 p-6 backdrop-blur-sm transition-all duration-500 hover:bg-white dark:border-white/20 dark:bg-white/10 dark:hover:bg-white/15">
                    ...
                    >
                      <div
                        className={`h-14 w-14 rounded-xl bg-gradient-to-r ${value.color} flex items-center justify-center shadow-lg transition-all duration-300 group-hover:shadow-xl`}
                      >
                      ...
                      <motion.div
                        ...
                        className="absolute -inset-2 rounded-xl border-2 border-dashed border-white/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                      />
                    </motion.div>
