      ...
      >
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6">
          ...
          >
            {filterOptions.map((filter) => (
              <motion.button
                ...
                className={`relative overflow-hidden rounded-full px-4 py-2 text-sm font-semibold transition-all duration-300 sm:px-6 sm:py-3 sm:text-base ${
                  activeFilter === filter
          ...
          >
            ...
            <div className="absolute -right-2 top-1/2 z-20 -translate-y-1/2 sm:-right-6 lg:-right-12">
              <motion.button
                          ...
                          <div className="project-card group relative flex h-[320px] flex-col overflow-hidden rounded-xl border border-white/20 bg-white/90 shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-2xl dark:border-gray-700/20 dark:bg-gray-800/90 sm:h-[420px] sm:rounded-2xl md:h-[480px] lg:h-[520px]">
                            ...
                            <div className="flex flex-1 flex-col p-3 sm:p-4 md:p-6">
                              ...
                              <div className="mb-2 flex items-center gap-1.5 sm:mb-3 sm:gap-2 md:mb-4">
                                ...
                                <span
                                  className={`text-xs font-medium sm:text-sm ${serviceInfo?.textColor}`}
                                >
                                  {mappedCategory}
                                </span>
                              </div>
                              ...
                              {/* Title */}
                              <h3 className="mb-2 line-clamp-2 text-[12px] font-bold text-gray-900 dark:text-white sm:mb-3 sm:text-lg md:text-xl">
                                {project.title}
                              </h3>

                              {/* Description */}
                              <p className="mb-2 line-clamp-2 text-xs text-gray-600 dark:text-gray-300 sm:mb-3 sm:text-sm md:mb-4">
                                {project.description}
                              </p>
