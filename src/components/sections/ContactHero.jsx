    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-accent-900">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute right-1/4 top-1/4 h-96 w-96 rounded-full bg-gradient-to-r from-accent-400/20 to-secondary-400/10 blur-3xl"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 left-1/4 h-80 w-80 rounded-full bg-gradient-to-l from-primary-400/15 to-accent-400/10 blur-3xl"
        />
      </div>

      <div className="container relative z-10 mx-auto flex min-h-screen items-center px-4 py-32">
        <motion.div
