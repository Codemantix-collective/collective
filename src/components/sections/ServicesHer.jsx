    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute -right-48 -top-48 h-96 w-96 rounded-full bg-gradient-to-br from-primary-400/10 to-accent-400/15 blur-3xl"
        />
        <motion.div
          animate={
            isVisible
          ...
          className="from-secondary-400/8 to-accent-400/12 absolute -bottom-48 -left-48 h-[32rem] w-[32rem] rounded-full bg-gradient-to-br blur-3xl"
        />

        {/* Service-themed Floating Particles */}
        {[...Array(25)].map((_, i) => (
          <motion.div
            key={i}
            animate={{
          ...
          <div className="space-y-8 pt-20 text-center lg:pt-0 lg:text-left">
            ...
            >
              ...
              <motion.div
                ...
                className="relative flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-accent-500"
              >
